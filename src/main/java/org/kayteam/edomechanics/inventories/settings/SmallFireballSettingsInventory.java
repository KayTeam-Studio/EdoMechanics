...
public class SmallFireballSettingsInventory extends InventoryBuilder {
    ...
    public SmallFireballSettingsInventory(EdoMechanics plugin) {
        super(plugin.getInventories().getString("settings.mechanic.title",
                new String[][]{{"%mechanic_name%", MechanicType.SMALL_FIREBALL.toString()}}), 5);
        ...
        addItem(20, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.cooldown"),
                new String[][] {{"%seconds%", settings.getInt("mechanics.smallFireball.cooldown") + ""}}));
        setUpdatable(20, true);
        setUpdateInterval(20, 4);
        addLeftAction(20, (player, i) -> {
            int cooldown = settings.getInt("mechanics.smallFireball.cooldown");
            if (cooldown > 0) {
                settings.set("mechanics.smallFireball.cooldown", cooldown - 1);
        ...
        addItem(21, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.minDamage"),
                new String[][]{{"%damage%", settings.getInt("mechanics.smallFireball.minDamage") + ""}}));
        setUpdatable(21, true);
        setUpdateInterval(21, 4);
        addLeftAction(21, (player, i) -> {
            int damage = settings.getInt("mechanics.smallFireball.minDamage");
            if (damage > 0) {
                settings.set("mechanics.smallFireball.minDamage", damage - 1);
                settings.saveFileConfiguration();
            }
        });
        addRightAction(21, (player, i) -> {
            int damage = settings.getInt("mechanics.smallFireball.minDamage");
            int maxDamage = settings.getInt("mechanics.smallFireball.maxDamage");
        ...
        addItem(22, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.maxDamage"),
                new String[][]{{"%damage%", settings.getInt("mechanics.smallFireball.maxDamage") + ""}}));
        setUpdatable(22, true);
        setUpdateInterval(22, 4);
        addLeftAction(22, (player, i) -> {
            int damage = settings.getInt("mechanics.smallFireball.maxDamage");
            int minDamage = settings.getInt("mechanics.smallFireball.minDamage");
            if (damage - 1 > minDamage) {
                settings.set("mechanics.smallFireball.maxDamage", damage - 1);
                settings.saveFileConfiguration();
            }
        });
        ...
        addItem(23, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.permissionToUse"),
                new String[][]{{"%permission%", settings.getString("mechanics.smallFireball.permissionToUse")}}));
        addLeftAction(23, (player, i) -> {
            ...
            plugin.getInputManager().addInput(player, new ChatInput() {
                ...
                public boolean onChatInput(Player player, String input) {
                    settings.set("mechanics.smallFireball.permissionToUse", input);
                    settings.saveFileConfiguration();
        ...
        addItem(24, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.permissionToBypassCooldown"),
                new String[][]{{"%permission%", settings.getString("mechanics.smallFireball.permissionToBypassCooldown")}}));
        addLeftAction(24, (player, i) -> {
            ...
            plugin.getInputManager().addInput(player, new ChatInput() {
                @Override
                public boolean onChatInput(Player player, String input) {
                    settings.set("mechanics.smallFireball.permissionToBypassCooldown", input);
                    settings.saveFileConfiguration();
                    plugin.getInventoryManager().openInventory(player, new SmallFireballSettingsInventory(plugin));
                    return true;
                }
