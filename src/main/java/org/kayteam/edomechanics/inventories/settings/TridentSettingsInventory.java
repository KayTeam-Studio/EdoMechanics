...
public class TridentSettingsInventory extends InventoryBuilder {
    ...
    public TridentSettingsInventory(EdoMechanics plugin) {
        super(plugin.getInventories().getString("settings.mechanic.title",
                new String[][]{{"%mechanic_name%", MechanicType.TRIDENT.toString()}}), 5);
        ...
        addItem(20, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.cooldown"),
                new String[][] {{"%seconds%", settings.getInt("mechanics.trident.cooldown") + ""}}));
        ...
        addItem(21, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.minDamage"),
                new String[][]{{"%damage%", settings.getInt("mechanics.trident.minDamage") + ""}}));
        ...
        addItem(22, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.maxDamage"),
                new String[][]{{"%damage%", settings.getInt("mechanics.trident.maxDamage") + ""}}));
        ...
        addItem(23, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.permissionToUse"),
                new String[][]{{"%permission%", settings.getString("mechanics.trident.permissionToUse")}}));
        ...
        addItem(24, () -> Yaml.replace(inventories.getItemStack("settings.mechanic.items.permissionToBypassCooldown"),
                new String[][]{{"%permission%", settings.getString("mechanics.trident.permissionToBypassCooldown")}}));
