...
public class ArrowMechanic extends Mechanic {
    ...
    public void actions() {
        ...
        final Projectile projectile = getPlayer().getWorld().spawn(getPlayer().getEyeLocation().add(
                ...
                getPlugin().getMechanicManager().getProjectileTypes().get(MechanicType.ARROW));
        projectile.setShooter(getPlayer());
        projectile.setVelocity(direction);
        projectile.setMetadata(projectile.getName(), new FixedMetadataValue(getPlugin(), "ArrowMechanic"));
    }
}
